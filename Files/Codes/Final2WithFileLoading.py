...
def show_input_plots():
    ...
    plt.title("Aylık Tüketim (kWh)"); plt.xlabel("Ölçüm"); plt.ylabel("Tüketim (kWh)"); plt.tight_layout(); plt.show()

    plt.figure(); plt.plot(range(1, len(d)+1), d, marker='o')
    plt.title("Demand (kW)"); plt.xlabel("Ölçüm"); plt.ylabel("Demand (kW)"); plt.tight_layout(); plt.show()
...
def prompt_and_show_user_plot():
    ...
    def plot_sel():
        ...
        plt.title("Aylık Tüketim (kWh)"); plt.xlabel("Ay"); plt.ylabel("Tüketim (kWh)")
        plt.legend(); plt.tight_layout(); plt.show()
